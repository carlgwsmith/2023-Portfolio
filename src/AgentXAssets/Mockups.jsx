import mock1 from '../assets/agents-mock1.png'
import mock2 from '../assets/agents-mock2.png'
import mock3 from '../assets/agents-mock3.png'
    ...
    return(
        <div className="bg-white p-10 pt-6 pb-10 text-jet">
            <div className="grid grid-cols-6 gap-4 align-middle items-center">
                ...
                <div className="col-span-6 text-center">
                <h2 className="text-xl font-semibold mb-2">Individual Agent Page</h2>
