import Palette from '../assets/agents-palette.png'
import ui1 from '../assets/agents-ui1.png'
import ui2 from '../assets/agents-ui2.png'
import Buttons from '../assets/agents-buttons.png'
    ...
    return(
        <div className="bg-background-light py-10 xs:px-10 sm:px-10 md:px-40 text-jet">
            <div className="grid grid-cols-6 gap-4 align-middle items-center">
                ...
                <div className="xs:col-span-6 sm:col-span-3 py-5">
                    <img src={Palette} width="600px"/>
                </div>
                <div className='xs:hidden sm:block col-span-1 py-5'>
                    <div className='horizontal-circle m-auto'></div>
                </div>
                <div className='xs:col-span-6 sm:col-span-2 py-5'>
                    <h2 className="text-xl font-semibold my-2">Color Palette</h2>
                ...
                <div className='xs:hidden sm:block sm:col-span-1 py-5'>
                    <div className='horizontal-circle m-auto'></div>
                </div>
                <div className='xs:col-span-6 sm:col-span-2 py-5'>
                    <h2 className="text-xl font-semibold my-2">Buttons</h2>
                ...
                <div className='xs:col-span-6 sm:col-span-2 py-5'>
                    <h2 className="text-xl font-semibold my-2">Typography & Iconography</h2>
                ...
                <div className='xs:col-span-6 col-start-2 sm:col-span-6 mt-4 py-5'>
                    <h2 className="text-xl font-semibold mb-2 text-center">Input Components</h2>
                     <p className='my-4'>Each input component has a consistent design crafted for flexibility and reusability. There are defined states that allow users to clearly identify their input selection with visual feedback. The components allow for scalability for added features.</p>
                </div>
