...
export default function AgentExplore (){
    ...
    return(
        <div>
            <Hero title="AgentXplore" desc="This application assists users in finding an insurance agent near them that suits their particular needs. Agents can also sign up to join the site to gain more visibility and engage with potential new clients." rightSide={HeroImg} image='true' id="top"/>
