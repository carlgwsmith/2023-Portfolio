import mock1 from '../IptiqAssets/home1.png'
import mock2 from '../IptiqAssets/startinganapp.png'
import mock3 from '../IptiqAssets/quoteandpay.png'

export default function Mockups(){
    return(
        <div className="bg-white p-10 pt-6 pb-10 text-jetbg-white py-10 xs:px-10 sm:px-10 md:px-40 text-jet">
            <div className="grid grid-cols-6 gap-4 align-middle items-center">
                ...
                <h2 className="text-xl font-semibold mb-2">Agent Login and Portal</h2>
                    <img src={mock1} className='m-auto'/>
                </div>
                <div className="col-span-6 text-center mt-10">
                <h2 className="text-xl font-semibold mb-2">Starting an Application</h2>
                    <img src={mock2} className='m-auto'/>
                </div>
                <div className="col-span-6 text-center mt-10">
                <h2 className="text-xl font-semibold mb-2">Quote and Pay</h2>
