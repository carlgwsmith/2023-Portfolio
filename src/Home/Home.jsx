...
I design and implement thoughtful and easy to use experiences for companies with complex problems." rightSide={<Canvas shadows style={{width: expWidth, height: expHeight, overflow:'hidden'}} camera={{
    fov: 60,
    zoom: 1.45,
    near: 0.1,
    far:100,
