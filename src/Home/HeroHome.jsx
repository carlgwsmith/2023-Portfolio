function HeroHome(props) {
    ...
    return(
        <>
        <div className="overflow-hidden grid grid-cols-12 min-h-[400px] ease-in-out duration-500 bg-background-light px-10">
            <div className="xs: col-span-12 sm:col-span-5 m-auto grid-rows-2">
                <div className="row-span-1">
                <div className="xs: text-5xl sm:text-5xl md:text-6xl font-extrabold tracking-wider text-jet mt-10">{props.title}</div>
